...
const skills = [
  ...
  { name: "C# / .NET 8", icon: <SiDotnet style={{ color: "#512bd4" }} /> },
  ...
  { name: "Azure (AZ-900 / DP-900 / AI-900 / SC-900)", icon: <VscAzure style={{ color: "#0078d4" }} /> },
  { name: "Cisco Networking (CCNA)", icon: <SiCisco style={{ color: "#1ba0d7" }} /> },
